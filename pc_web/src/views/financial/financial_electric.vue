    ...
    <div class="table-container">
      ...
      <div class="table">
        <el-table :data="tableData" stripe style="width: 100%" height="454" :default-sort="{ prop: 'date', order: 'descending' }">
          ...
          <el-table-column prop="numElectric" label="用电量(度)" width="180"> </el-table-column>
          <el-table-column prop="costElectric" label="电费(元)" width="180"> </el-table-column>
          <el-table-column prop="uploadElectric" label="上传时间"> </el-table-column>
      ...
      <div class="drawer">
        <el-drawer title="电费表解析" :visible.sync="drawer" :wrapperClosable="false" :show-close="false">
          <div class="drawer-container">
            <div class="table">
              ...
              <el-table :data="hasData" border style="width: 100%" size="mini" height="320">
                ...
                <el-table-column prop="num" label="用电量(度)">
                  <template slot-scope="scope">
      ...
      <div class="drawer">
        <el-drawer title="电费表解析" :visible.sync="toggleDrawer" :wrapperClosable="false" :show-close="false">
          <div class="drawer-container">
            <div class="table">
              <h3>新数据：</h3>
              <el-table :data="newData" border style="width: 100%" size="mini" height="240" @selection-change="handleSelectionChange">
                ...
                <el-table-column prop="houseName" label="房号"> </el-table-column>
                <el-table-column prop="time" label="月份"> </el-table-column>
                <el-table-column prop="num" label="用电量(度)"> </el-table-column>
              </el-table>
            </div>
            <div class="table">
              <h3>源数据：</h3>
...
import { sheetElectricExcel, getElectricExcel, judgeElectric, toggleElectric, getAllCost, updateElectricByCostId } from '@/api/cost';
...
export default {
  ...
  methods: {
      ...
      if (files.length === 0) {
        ...
        if (this.beforeAvatarUpload(files[0])) {
          try {
            ...
            const { data } = await getElectricExcel(form);
    ...
    //确认添加
    add() {
      this.$confirm('此操作将添加本月的用电数据, 是否继续?', '提示', {
        confirmButtonText: '确定',
        cancelButtonText: '取消',
        type: 'warning'
      })
        .then(async () => {
          try {
            const { data } = await judgeElectric({
