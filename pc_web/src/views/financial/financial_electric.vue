<template>
  <div class="main-container">
    <div class="header-container">
      <h1>用 电 管 理</h1>
      <div class="btn">
        <el-button class="cancel" :disabled="isGet" @click="download"
          >下 载 模 板</el-button
        >
        <el-button class="save" :disabled="isAdd" @click="upload"
          >上传</el-button
        >
        <input
          type="file"
    ...
    <div class="table-container">
      ...
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="houseName" label="房号" width="180">
          </el-table-column>
          <el-table-column prop="numElectric" label="用电量(度)" width="180">
          </el-table-column>
          <el-table-column prop="costElectric" label="电费(元)" width="180">
          </el-table-column>
          <el-table-column prop="uploadElectric" label="上传时间">
          </el-table-column>
          <el-table-column label="操作" width="100">
            <template slot-scope="scope">
              <el-button
                type="primary"
                size="small"
                :disabled="isEdit || scope.row.state != `0`"
      ...
      <div class="drawer">
        ...
        >
          <div class="drawer-container">
            ...
            <div class="btn">
              <el-button type="primary" @click="toggle" :disabled="isTooggle"
                >替 换</el-button
              >
